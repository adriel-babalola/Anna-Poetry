  ...
  return (data ? <>
    <div className='bg-gray-200 py-5 px-4 md:px-12 lg:px-28'>
      <div className='flex justify-between items-center gap-2'>
        ...
        <button className='flex items-center gap-2 font-medium text-sm sm:text-sm py-1 px-3 sm:py-3 sm:px-6 border border-black shadow-[-7px_7px_0px_#000000]'>Get Started
          <Image src={assets.arrow} alt='' className='hidden sm:inline' />
        </button>
      </div>
